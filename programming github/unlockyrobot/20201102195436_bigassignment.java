...
/**
* To report the current x and y position of the robot, the total score, and the
...
/**
* To receive the coordinates together with the direction that the user has entered
* @param x the x coordinate (position)
* @param y the y coordinate (position
* @param direction the direction the user inputs (u, d , l, r)
* @return true if the robot exceeds the grid limits will be false otherwise 
*/
...
/**
* called when the robot makes a move and ends up in the in of the cells
* once it gets calls this method will roll a dice
...
* @param reward gives reward to the robot
...
/**
* bringing a string to title case.
...
/**
* asking the user to input a direction
